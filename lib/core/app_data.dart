...
import 'package:rapyd_collect_api/src/model/furniture_color.dart';
import 'package:rapyd_collect_api/src/model/bottom_navigation_item.dart';
...
class AppData {
  ...
  static List<BottomNavigationItem> bottomNavigationItems = [
    const BottomNavigationItem(Icon(Icons.shopping_bag_outlined), 'Items'),
    const BottomNavigationItem(Icon(Icons.star_outline_rounded), 'Plans'),
